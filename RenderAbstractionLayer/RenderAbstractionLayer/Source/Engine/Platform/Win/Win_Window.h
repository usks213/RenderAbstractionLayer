...
#include <Engine/Platform/Core/Core_Window.h>
#include <Windows.h>
...
namespace win
{
	...
	public:
		...
		bool initialize(HINSTANCE& hInstance, std::string className, int nCmdShow, WNDPROC lpfnWndProc);
